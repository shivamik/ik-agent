PROMPT="I have an image https://ik.imagekit.io/2pej2semh/Actual%20Image.png?updatedAt=1762759815408 in my account. Remove its background and save it as 'actual_image_no_bg.png'?"
