...
async def get_accounts_url_endpoints(
    *,
    id: str,
    filter_spec: Optional[Any] = None,
) -> Dict[str, Any]:
    """
    Retrieve a URL endpoint by ID (beta).

    - Use `filter_spec` (glom spec) to shrink the response payload.
    """
    raw = await CLIENT.accounts.url_endpoints.get(id)
...
async def get_accounts_url_endpoints_tool(
    id: str,
    filter_spec: Optional[Any] = None,
) -> Dict[str, Any]:
    """
    ...
    """
    return await get_accounts_url_endpoints(id=id, filter_spec=filter_spec)
